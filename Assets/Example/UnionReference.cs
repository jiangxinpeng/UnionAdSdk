...
namespace Library
{
    ...
    /// 穿山甲广告的官方参考demo代码
    /// </summary>
    public sealed class UnionReference : MonoBehaviour
    {
        [SerializeField]
        ...
        private AndroidJavaClass mUnionApplication;
    ...
    private ExpressInterstitialAd iExpressInterstitialAd; // for iOS
        ...
        public void Awake()
        {
            mUnionApplication = new AndroidJavaClass("com.bytedance.android.UnionApplication");
            mUnionApplication.CallStatic("InitUnion", GetActivity(), "5001121", "测试app", true);
        }
       ...
       if (bannerAd == null)
        ...
        {
            private UnionReference example;

            public RewardVideoAdListener(UnionReference example)
            {
        ...
        private sealed class ExpressRewardVideoAdListener : IRewardVideoAdListener
        {
            ...
            public ExpressRewardVideoAdListener(UnionReference example)
            {
                this.example = example;
            }
        ...
        private sealed class FullScreenVideoAdListener : IFullScreenVideoAdListener
        {
            ...
            public FullScreenVideoAdListener(UnionReference example)
            {
                this.example = example;
            }
        ...
        private sealed class ExpressFullScreenVideoAdListener : IFullScreenVideoAdListener
        {
            ...
            public ExpressFullScreenVideoAdListener(UnionReference example)
            {
                this.example = example;
            }
       ...
       if (this.example.expressFullScreenVideoAd != null)
        ...
        private sealed class ExpressAdListener : IExpressAdListener
        {
            ...
            public ExpressAdListener(UnionReference example, int type)
            {
                this.example = example;
                this.type = type;
        ...
        private sealed class ExpressAdInteractionListener : IExpressAdInteractionListener
        {
            ...
            public ExpressAdInteractionListener(UnionReference example, int type)
            {
                this.example = example;
                this.type = type;
            }
        ...
        private sealed class ExpressAdDislikeCallback : IDislikeInteractionListener
        {
            ...
            public ExpressAdDislikeCallback(UnionReference example, int type)
            {
                this.example = example;
                this.type = type;
            }
        ...
        private sealed class NativeAdInteractionListener : IInteractionAdInteractionListener
        {
            private UnionReference example;
            int type;//0:feed   1:banner
            public NativeAdInteractionListener(UnionReference example, int type)
            {
                this.example = example;
            }
        ...
        private sealed class NativeAdListener : INativeAdListener
        {
            ...
            public NativeAdListener(UnionReference example)
            {
                this.example = example;
            }
        ...
        private sealed class FullScreenAdInteractionListener : IFullScreenVideoAdInteractionListener
        {
            ...
            public FullScreenAdInteractionListener(UnionReference example)
            {
                this.example = example;
            }
        ...
        private sealed class RewardAdInteractionListener : IRewardAdInteractionListener
        {
            ...
            public RewardAdInteractionListener(UnionReference example)
            {
                this.example = example;
            }
        ...
        private sealed class SplashAdListener : ISplashAdListener
        {
            ...
            public SplashAdListener(UnionReference example)
            {
                this.example = example;
            }

            public SplashAdListener(UnionReference example, AndroidJavaObject activity, AndroidJavaObject splashAdManager)
            {
                this.example = example;
            ...
            private sealed class SplashAdInteractionListener : ISplashAdInteractionListener
            {
                ...
                private AndroidJavaObject activity;
                private AndroidJavaObject splashAdManager;
                public SplashAdInteractionListener(UnionReference example)
                {
                    this.example = example;
                }

                public SplashAdInteractionListener(UnionReference example, AndroidJavaObject activity, AndroidJavaObject splashAdManager)
                {
                    this.example = example;
                    this.activity = activity;
                    this.splashAdManager = splashAdManager;
        ...
        private sealed class ExpressSplashAdListener : ISplashAdListener
        {
            ...
            public ExpressSplashAdListener(UnionReference example)
            {
                this.example = example;
            }
        ...
        private sealed class ExpressSplashAdInteractionListener : ISplashAdInteractionListener
        {
            ...
            public ExpressSplashAdInteractionListener(UnionReference example)
            {
                this.example = example;
            }
        ...
        private sealed class AppDownloadListener : IAppDownloadListener
        {
            ...
            public AppDownloadListener(UnionReference example)
            {
                this.example = example;
            }
